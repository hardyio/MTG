...
public class Article implements Parcelable {
    ...
    public Article(String apkLink, String author, int chapterId, String chapterName, boolean collect, int courseId, String desc, String envelopePic, boolean fresh, int id, String link, String niceDate, String origin, String prefix, String projectLink, long publishTime, int superChapterId, String superChapterName, String title, int type, int userId, int visible, int zan, List<Tag> tags, boolean isTop, int selfVisible, String shareUser, int originId) {
